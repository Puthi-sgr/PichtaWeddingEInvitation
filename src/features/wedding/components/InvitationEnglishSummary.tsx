  ...
  return (
    ...
    >
      <div className="wedding-text-primary mx-auto w-full max-w-3xl font-english">
        ...
        <div className="text-radial-backdrop text-radial-backdrop--block mx-auto mt-6 max-w-xl">
          <p className="font-english-sub wedding-text-secondary crown-gold-leaf-text text-base leading-relaxed md:text-lg">
        ...
        <div className="mx-auto mt-10 grid max-w-2xl grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-4 md:gap-7">
          <div className="min-w-0">
            ...
            <div className="text-radial-backdrop text-radial-backdrop--block mt-3">
              <p className="wedding-text-secondary crown-gold-leaf-text text-3xl leading-snug md:text-4xl">{invitation.groomName}</p>
            </div>
          </div>
          <span className="text-radial-backdrop gold-text text-3xl leading-none md:text-5xl" aria-hidden="true">{invitation.unionText}</span>
          <div className="min-w-0">
            <div className="text-radial-backdrop text-radial-backdrop--block">
              <p className="gold-text font-english-sub text-xl font-bold">{invitation.brideLabel}</p>
            </div>
            <div className="text-radial-backdrop text-radial-backdrop--block mt-3">
              <p className="wedding-text-secondary crown-gold-leaf-text text-3xl leading-snug md:text-4xl">{invitation.brideName}</p>
            </div>
          </div>
        </div>

        <div className="text-radial-backdrop text-radial-backdrop--block mx-auto mt-9 max-w-xl">
          <p className="font-english-sub wedding-text-secondary crown-gold-leaf-text text-base leading-relaxed md:text-lg">{invitation.formalLine}</p>
        </div>
        ...
        <dl className="font-english-sub mx-auto mt-8 max-w-2xl text-center text-sm leading-[1.75] md:text-base">
          <div className="grid grid-cols-1">
            <div className="min-w-0 px-4 py-5 sm:px-6">
              ...
              <div className="text-radial-backdrop text-radial-backdrop--block mt-2">
                <dd className="crown-gold-leaf-text break-words">{invitation.date}</dd>
              </div>
            ...
            <div className="min-w-0 px-4 py-5 sm:px-6">
              ...
              <div className="text-radial-backdrop text-radial-backdrop--block mt-2">
                <dd className="wedding-text-secondary crown-gold-leaf-text break-words">{invitation.time}</dd>
              </div>
              <WeddingSectionDivider preset="tapered-rule" length="8rem" className="mx-auto mt-4" />
            </div>
          </div>
          <div className="px-4 py-5 text-center sm:px-6">
            ...
            <div className="text-radial-backdrop text-radial-backdrop--block mt-2 max-w-xl">
              <dd className="wedding-text-secondary crown-gold-leaf-text break-words">{invitation.location}</dd>
            </div>
            <WeddingSectionDivider preset="tapered-rule" length="8rem" className="mx-auto mt-4" />
            <ShareButton
